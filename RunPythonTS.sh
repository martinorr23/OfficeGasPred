...
hadoop jar /usr/lib/hadoop/hadoop-streaming.jar -files tsmapper.py,tsreducer.py,tscombiner.py -mapper mapper.py -reducer reducer.py -combiner tscombiner.py -input /SSPProj -output /SSPProjOut --cmdenv window_size=5
